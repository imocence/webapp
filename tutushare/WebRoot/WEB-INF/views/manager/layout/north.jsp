...
<script type="text/javascript" charset="utf-8">
	function logoutFun(b) {
		$.getJSON("<c:url value='/userController/logout.action'/>", function(result) {
			if (b) {
	...
	function userInfoFun() {
		$('<div/>').dialog({
//			href : "<c:url value='/userController/userInfo.action'/>",
			width : 490,
			height : 285,
			modal : true,
			title : '用户信息',
...
//						url : "<c:url value='/userController/modifyCurrentUserPwd.action'/>",
...
<div id="layout_north_pfMenu" style="width: 120px; display: none;">
	...
	<div onclick="changeTheme('cupertino');">metro</div>
</div>

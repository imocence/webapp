package com.tutushare.pattern.Multition;
...
public class Emperor {
	...
	// 皇帝叫什么名字
	private static List emperorInfoList = new ArrayList(maxNumOfEmperor);

	// 装皇帝的列表；
	private static List emperorList = new ArrayList(maxNumOfEmperor);
